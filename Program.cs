...
namespace delegatesAndEvents
{
    ...
    public class Race
    {
        ...
        public event myDelegate raceWon;
    ...
    class Program
    {
        public static void Main()
        {
            ...
            round1.raceWon += footRace;
            // trigger the event
            round1.Racing(5, 1);
            // register with the carRace event
            round1.raceWon-= footRace;
            round1.raceWon += carRace;
            //trigger the event
            round1.Racing(10, 15);
            // register a bike race event using a lambda expression
            round1.raceWon-= carRace;
            round1.raceWon += (winner) => Console.WriteLine($"The bike race winner is number {winner}.");
            // trigger the event
            round1.Racing(12, 5);
        }
